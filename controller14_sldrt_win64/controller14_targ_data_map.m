    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(133)  = dumData; %prealloc
                    ...
                    section.data(48).dtTransOffset = 101;
                    ...
                    section.data(105).dtTransOffset = 187;
                    ...
                    section.data(114).dtTransOffset = 208;
                    ...
                    section.data(124).dtTransOffset = 221;

                    ;% controller14_B.eulx
                    section.data(125).logicalSrcIdx = 138;
                    section.data(125).dtTransOffset = 222;

                    ;% controller14_B.eulZYX
                    section.data(126).logicalSrcIdx = 139;
                    section.data(126).dtTransOffset = 223;

                    ;% controller14_B.rd
                    section.data(127).logicalSrcIdx = 140;
                    section.data(127).dtTransOffset = 226;
                    ...
                    section.data(133).dtTransOffset = 248;
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    section.data(4).logicalSrcIdx = 172;
                    section.data(4).dtTransOffset = 7;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(93)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.Memory_PreviousInput
                    section.data(69).logicalSrcIdx = 68;
                    ...
                    ;% controller14_DW.time_a
                    section.data(75).logicalSrcIdx = 74;
                    section.data(75).dtTransOffset = 148;

                    ;% controller14_DW.p_old
                    section.data(76).logicalSrcIdx = 75;
                    section.data(76).dtTransOffset = 149;

                    ;% controller14_DW.vel_old
                    section.data(77).logicalSrcIdx = 76;
                    section.data(77).dtTransOffset = 151;

                    ;% controller14_DW.time_old
                    section.data(78).logicalSrcIdx = 77;
                    section.data(78).dtTransOffset = 153;

                    ;% controller14_DW.is_first
                    section.data(79).logicalSrcIdx = 78;
                    ...
                    ;% controller14_DW.id
                    section.data(84).logicalSrcIdx = 83;
                    section.data(84).dtTransOffset = 175;

                    ;% controller14_DW.som_state
                    section.data(85).logicalSrcIdx = 84;
                    section.data(85).dtTransOffset = 176;
                    ...
                    section.data(89).logicalSrcIdx = 88;
                    section.data(89).dtTransOffset = 180;
            ...
            section.data(40)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.Scope_PWORK_hq.LoggedData
                    ...
                    ;% controller14_DW.Scope2_PWORK_n.LoggedData
            ...
            section.data(23)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.is_active_c30_controller14
            ...
            section.data(49)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.time_not_empty_n
                    section.data(14).logicalSrcIdx = 199;
                    section.data(14).dtTransOffset = 13;

                    ;% controller14_DW.p_old_not_empty
                    section.data(15).logicalSrcIdx = 200;
                    section.data(15).dtTransOffset = 14;

                    ;% controller14_DW.vel_old_not_empty
                    section.data(16).logicalSrcIdx = 201;
                    section.data(16).dtTransOffset = 15;

                    ;% controller14_DW.time_old_not_empty
                    section.data(17).logicalSrcIdx = 202;
                    section.data(17).dtTransOffset = 16;

                    ;% controller14_DW.is_first_not_empty
    ...
    targMap.checksum0 = 4202793558;
    targMap.checksum1 = 1462910279;
    targMap.checksum2 = 3103049968;
    targMap.checksum3 = 2458485700;
