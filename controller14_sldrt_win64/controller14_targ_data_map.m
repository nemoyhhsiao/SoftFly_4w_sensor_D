    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% controller14_P.archived_Eul_XYZ
                    section.data(1).logicalSrcIdx = 8;
                    section.data(1).dtTransOffset = 0;

                    ;% controller14_P.archived_p_raw
                    section.data(2).logicalSrcIdx = 9;
                    section.data(2).dtTransOffset = 270003;
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% controller14_P.archived_data_ready
            ...
            section.data(170)  = dumData; %prealloc
                    ...
                    section.data(97).dtTransOffset = 134;
                    ...
                    section.data(115).logicalSrcIdx = 125;
                    ...
                    section.data(121).logicalSrcIdx = 131;
                    section.data(121).dtTransOffset = 159;

                    ;% controller14_P.RampUpOrDown_IC_j
                    section.data(122).logicalSrcIdx = 132;
                    section.data(122).dtTransOffset = 160;

                    ;% controller14_P.RampUpOrDown_UpperSat_c
                    section.data(123).logicalSrcIdx = 133;
                    section.data(123).dtTransOffset = 161;

                    ;% controller14_P.RampUpOrDown_LowerSat_c
                    section.data(124).logicalSrcIdx = 134;
                    section.data(124).dtTransOffset = 162;

                    ;% controller14_P.phaseoffset_Value_k
                    section.data(125).logicalSrcIdx = 135;
                    section.data(125).dtTransOffset = 163;

                    ;% controller14_P.degtorad_Gain_f
                    section.data(126).logicalSrcIdx = 136;
                    section.data(126).dtTransOffset = 164;

                    ;% controller14_P.omegat_gainval_e
                    section.data(127).logicalSrcIdx = 137;
                    section.data(127).dtTransOffset = 165;

                    ;% controller14_P.omegat_IC_i
                    section.data(128).logicalSrcIdx = 138;
                    section.data(128).dtTransOffset = 166;

                    ;% controller14_P.Gain1_Gain_do
                    section.data(129).logicalSrcIdx = 139;
                    section.data(129).dtTransOffset = 167;

                    ;% controller14_P.Delay_InitialCondition_i
                    section.data(130).logicalSrcIdx = 140;
                    section.data(130).dtTransOffset = 168;

                    ;% controller14_P.Delay1_InitialCondition_i
                    section.data(131).logicalSrcIdx = 141;
                    section.data(131).dtTransOffset = 169;

                    ;% controller14_P.Delay2_InitialCondition_eq
                    section.data(132).logicalSrcIdx = 142;
                    section.data(132).dtTransOffset = 171;

                    ;% controller14_P.ground_Value_l
                    section.data(133).logicalSrcIdx = 143;
                    section.data(133).dtTransOffset = 172;

                    ;% controller14_P.Gain3_Gain
                    section.data(134).logicalSrcIdx = 144;
                    section.data(134).dtTransOffset = 173;

                    ;% controller14_P.constant_Value
                    section.data(135).logicalSrcIdx = 145;
                    section.data(135).dtTransOffset = 174;

                    ;% controller14_P.time_gainval_oa
                    section.data(136).logicalSrcIdx = 146;
                    section.data(136).dtTransOffset = 175;

                    ;% controller14_P.time_IC_b
                    section.data(137).logicalSrcIdx = 147;
                    section.data(137).dtTransOffset = 176;

                    ;% controller14_P.DiscreteTimeIntegrator_gainval
                    section.data(138).logicalSrcIdx = 148;
                    section.data(138).dtTransOffset = 177;

                    ;% controller14_P.DiscreteTimeIntegrator_IC
                    section.data(139).logicalSrcIdx = 149;
                    section.data(139).dtTransOffset = 178;

                    ;% controller14_P.constant_Value_i
                    section.data(140).logicalSrcIdx = 150;
                    section.data(140).dtTransOffset = 182;

                    ;% controller14_P.constant_Value_a
                    section.data(141).logicalSrcIdx = 151;
                    section.data(141).dtTransOffset = 183;

                    ;% controller14_P.constant_Value_j
                    section.data(142).logicalSrcIdx = 152;
                    section.data(142).dtTransOffset = 184;

                    ;% controller14_P.Saturation6_UpperSat
                    section.data(143).logicalSrcIdx = 153;
                    section.data(143).dtTransOffset = 185;

                    ;% controller14_P.Saturation6_LowerSat
                    section.data(144).logicalSrcIdx = 154;
                    section.data(144).dtTransOffset = 186;

                    ;% controller14_P.Saturation7_UpperSat
                    section.data(145).logicalSrcIdx = 155;
                    section.data(145).dtTransOffset = 187;

                    ;% controller14_P.Saturation7_LowerSat
                    section.data(146).logicalSrcIdx = 156;
                    section.data(146).dtTransOffset = 188;

                    ;% controller14_P.Saturation8_UpperSat
                    section.data(147).logicalSrcIdx = 157;
                    section.data(147).dtTransOffset = 189;

                    ;% controller14_P.Saturation8_LowerSat
                    section.data(148).logicalSrcIdx = 158;
                    section.data(148).dtTransOffset = 190;

                    ;% controller14_P.Saturation9_UpperSat
                    section.data(149).logicalSrcIdx = 159;
                    section.data(149).dtTransOffset = 191;

                    ;% controller14_P.Saturation9_LowerSat
                    section.data(150).logicalSrcIdx = 160;
                    section.data(150).dtTransOffset = 192;

                    ;% controller14_P.upi_Gain
                    section.data(151).logicalSrcIdx = 161;
                    section.data(151).dtTransOffset = 193;

                    ;% controller14_P.Gain_Gain_m
                    section.data(152).logicalSrcIdx = 162;
                    section.data(152).dtTransOffset = 194;

                    ;% controller14_P.Constant_Value_j
                    section.data(153).logicalSrcIdx = 163;
                    section.data(153).dtTransOffset = 195;

                    ;% controller14_P.Gain_Gain_k
                    section.data(154).logicalSrcIdx = 164;
                    section.data(154).dtTransOffset = 196;

                    ;% controller14_P.Constant_Value_o
                    section.data(155).logicalSrcIdx = 165;
                    section.data(155).dtTransOffset = 197;

                    ;% controller14_P.upi_Gain_o
                    section.data(156).logicalSrcIdx = 166;
                    section.data(156).dtTransOffset = 198;

                    ;% controller14_P.Gain_Gain_j
                    section.data(157).logicalSrcIdx = 167;
                    section.data(157).dtTransOffset = 199;

                    ;% controller14_P.Constant_Value_kj2
                    section.data(158).logicalSrcIdx = 168;
                    section.data(158).dtTransOffset = 200;

                    ;% controller14_P.Gain_Gain_h
                    section.data(159).logicalSrcIdx = 169;
                    section.data(159).dtTransOffset = 201;

                    ;% controller14_P.Constant_Value_jy
                    section.data(160).logicalSrcIdx = 170;
                    section.data(160).dtTransOffset = 202;

                    ;% controller14_P.upi_Gain_b
                    section.data(161).logicalSrcIdx = 171;
                    section.data(161).dtTransOffset = 203;

                    ;% controller14_P.Gain_Gain_o
                    section.data(162).logicalSrcIdx = 172;
                    section.data(162).dtTransOffset = 204;

                    ;% controller14_P.Constant_Value_mx
                    section.data(163).logicalSrcIdx = 173;
                    section.data(163).dtTransOffset = 205;

                    ;% controller14_P.Gain_Gain_o0
                    section.data(164).logicalSrcIdx = 174;
                    section.data(164).dtTransOffset = 206;

                    ;% controller14_P.Constant_Value_lu
                    section.data(165).logicalSrcIdx = 175;
                    section.data(165).dtTransOffset = 207;

                    ;% controller14_P.upi_Gain_e
                    section.data(166).logicalSrcIdx = 176;
                    section.data(166).dtTransOffset = 208;

                    ;% controller14_P.Gain_Gain_ks
                    section.data(167).logicalSrcIdx = 177;
                    section.data(167).dtTransOffset = 209;

                    ;% controller14_P.Constant_Value_mk
                    section.data(168).logicalSrcIdx = 178;
                    section.data(168).dtTransOffset = 210;

                    ;% controller14_P.Gain_Gain_p
                    section.data(169).logicalSrcIdx = 179;
                    section.data(169).dtTransOffset = 211;

                    ;% controller14_P.Constant_Value_kv
                    section.data(170).logicalSrcIdx = 180;
                    section.data(170).dtTransOffset = 212;
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(90)  = dumData; %prealloc
                    ...
                    section.data(90).dtTransOffset = 190;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(60)  = dumData; %prealloc
                    ...
                    section.data(49).logicalSrcIdx = 48;
                    section.data(49).dtTransOffset = 88;
                    ...
                    section.data(53).logicalSrcIdx = 52;
                    section.data(53).dtTransOffset = 110;
            ...
            section.data(15)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.is_active_c9_controller14
                    section.data(14).logicalSrcIdx = 115;
                    section.data(14).dtTransOffset = 13;

                    ;% controller14_DW.is_active_c8_controller14
            ...
            section.data(21)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.doneDoubleBufferReInit_nn
    ...
    targMap.checksum0 = 2411836380;
    targMap.checksum1 = 2096538749;
    targMap.checksum2 = 3994337035;
    targMap.checksum3 = 1026864313;
