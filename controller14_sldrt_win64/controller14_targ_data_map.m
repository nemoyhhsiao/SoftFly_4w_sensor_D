    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(133)  = dumData; %prealloc
                    ...
                    section.data(120).dtTransOffset = 217;
                    ...
                    section.data(128).dtTransOffset = 233;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(89)  = dumData; %prealloc
                    ...
                    section.data(51).logicalSrcIdx = 50;
                    section.data(51).dtTransOffset = 106;

                    ;% controller14_DW.omegat_DSTATE_p
                    section.data(52).logicalSrcIdx = 51;
                    section.data(52).dtTransOffset = 107;
                    ...
                    section.data(63).logicalSrcIdx = 62;
                    section.data(63).dtTransOffset = 121;
                    ...
                    section.data(73).logicalSrcIdx = 72;
                    section.data(73).dtTransOffset = 151;

                    ;% controller14_DW.time_g
                    section.data(74).logicalSrcIdx = 73;
                    section.data(74).dtTransOffset = 152;

                    ;% controller14_DW.x_hat_old
                    section.data(75).logicalSrcIdx = 74;
                    section.data(75).dtTransOffset = 153;
                    ...
                    section.data(78).logicalSrcIdx = 77;
                    section.data(78).dtTransOffset = 165;
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% controller14_DW.Scope4_PWORK.LoggedData
                    ...
                    ;% controller14_DW.Scope5_PWORK_c.LoggedData
    ...
    targMap.checksum0 = 3732782155;
    targMap.checksum1 = 2704886674;
    targMap.checksum2 = 1666181255;
    targMap.checksum3 = 4095110427;
