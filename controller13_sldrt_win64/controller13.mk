...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2023a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := controller13
MODULES              := controller13_data.c controller13_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := controller13.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2023a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := controller13_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/SMRL/Documents/GitHub/SoftFly_NNMPC_SLDRT;C:/Users/SMRL/Documents/GitHub/SoftFly_NNMPC_SLDRT/controller13_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
