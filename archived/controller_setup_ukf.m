function [ukf_sys, ukf_s0, ukf_P0_flat, ukf_prediction_time, ukf_use_prediction] = controller_setup_ukf(rbt, mdl, rsim)
...
ukf_params.Q_F_ext = 1e-6;
ukf_params.Q_dp = 1e-5;
ukf_params.Q_omega = 3e-1;
ukf_params.Q_tau_ext = 10e-13; % was 5
...
ukf_params.c_dv = mdl.drag_force.linear; % rbt.drag_force exists, but isn't actually used in simulink dynamics?
...
ukf_params.c_domega = rsim.rbt.torque_damping;
...
ukf_prediction_time = 0.015; % Get rid of some sensing delay
