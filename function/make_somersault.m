function som = make_somersault(mdl, rsim)
    ...
    som.thrust.acc = mdl.g * 1.4; % acceleration at phase 1 (lift2weight ratio)
    som.thrust.dec = mdl.g * 1.5; % deceleration at phase 4 (lift2weight ratio)
    ...
    som.gain.fact.st4.at3 = 0.5; % attitude d
    som.gain.fact.st4.at2 = 0.7; % attitude p
