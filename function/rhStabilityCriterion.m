function rhStabilityCriterion(coef)
...
coeffVector = coef; %input('input vector of your system coefficients: \n i.e. [an an-1 an-2 ... a0] = ');
...
%     fprintf('~~~~~> it is a stable system! <~~~~~\n')
    fprintf('\n#### this set of gains is stable #### \n')
else
    error('~~~~~> it is an unstable system! <~~~~~\n')
end
